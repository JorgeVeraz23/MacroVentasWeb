...
import { getCasoSelector } from '../../app/redux/actions/SelectoresActions/SelectoresActions';
...
export default function CasoSelect(props: Props) {
    const { 
        value, 
        placeholder = "Select...", 
        isSearchable = true, 
    ...
    const state = useAppSelector(state => state.SelectorCaso);
